...
export const Columns = ({isStackedOnMobile, children, textColor,  backgroundColor, classNm}) => {
    ...
    return (
        <div class={classNm ? classNm : ''} className={styles.columnsWrapper} style={{ ...textColorStyle, ...backgroundColorStyle }}>
